  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-zinc-50 via-white to-zinc-100">
      ...
      >
        <Link
          href="/"
          className="group flex items-center gap-2 rounded-full border border-zinc-200 bg-white/80 px-5 py-2.5 text-sm font-medium text-zinc-600 shadow-sm backdrop-blur-sm transition-all duration-200 hover:border-zinc-300 hover:bg-white hover:text-zinc-900 hover:shadow-md"
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-12">
        ...
        >
          ...
          <motion.div
            ...
            className="rounded-3xl border border-zinc-200/80 bg-white/80 p-8 shadow-xl shadow-zinc-200/50 backdrop-blur-xl"
          >
              ...
              {isGoogleConfigured && (
                ...
                >
                  <Button
                    ...
                    variant="outline"
                    disabled={isLoading}
                    className="h-14 w-full rounded-2xl border-2 border-zinc-200 text-base font-medium transition-all duration-200 hover:border-zinc-300 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-50"
